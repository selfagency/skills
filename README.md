...
| `lint-format-typecheck-ci-hooks` | `skills/lint-format-typecheck-ci-hooks/` | Toolchain-aware typecheck, lint, format, pre-commit, and GitHub Actions CI setup for Oxc, Biome, or ESLint+Prettier, with optional Rumdl Markdown supersedence and check-only CI guidance. |
